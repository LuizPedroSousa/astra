...
void register_console_commands(RenderBenchmark &render_benchmark) {
  ...
  console.register_command("spawn_cube", "Spawn a dynamic cube into the arena.", [&render_benchmark](const ConsoleCommandInvocation &) {
    render_benchmark.request_spawn_cube();
  ...
  console.register_command(
      "stats", "Print scene, renderable, and rigidbody counters.", [&render_benchmark](const ConsoleCommandInvocation &) {
