...
public:
  ...
  StyleBuilder &max_width(UILength value) {
    return add([value](UIStyle &style) { style.max_width = value; });
  }

  StyleBuilder &max_height(UILength value) {
    return add([value](UIStyle &style) { style.max_height = value; });
  }

  StyleBuilder &min_width(UILength value) {
    return add([value](UIStyle &style) { style.min_width = value; });
  }

  StyleBuilder &min_height(UILength value) {
    return add([value](UIStyle &style) { style.min_height = value; });
  }
  ...
  StyleBuilder &padding(UIEdges value) {
    return add([value](UIStyle &style) { style.padding = value; });
  }
  ...
  StyleBuilder &cursor(CursorStyle value) {
    return add([value](UIStyle &style) { style.cursor = value; });
  }
